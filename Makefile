# This Makefile is for the POE::SAPI::LocalAuth extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI/LocalAuth.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI::LocalAuth]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI/LocalAuth.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = POE::SAPI::LocalAuth
NAME_SYM = POE_SAPI_LocalAuth
VERSION = 0.03
...
MAKE = make
FULLEXT = POE/SAPI/LocalAuth
BASEEXT = LocalAuth
PARENT_NAME = POE::SAPI
DLBASE = $(BASEEXT)
VERSION_FROM = lib/POE/SAPI/LocalAuth.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/POE/SAPI/LocalAuth.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/POE/SAPI
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/POE/SAPI
...
TO_INST_PM = lib/POE/SAPI/LocalAuth.pm

PM_TO_BLIB = lib/POE/SAPI/LocalAuth.pm \
	blib/lib/POE/SAPI/LocalAuth.pm
...
DISTNAME = POE-SAPI-LocalAuth
DISTVNAME = POE-SAPI-LocalAuth-0.03
...
manifypods : pure_all  \
	lib/POE/SAPI/LocalAuth.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI/LocalAuth.pm $(INST_MAN3DIR)/POE::SAPI::LocalAuth.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Paul G Webster &lt;paul@daemonrage.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="amd64-freebsd-5.10" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI/LocalAuth.pm blib/lib/POE/SAPI/LocalAuth.pm 
